...
void runTcpClient(unsigned short port)
{
    ...
    if (socket.connect(server.Any, port) != sf::Socket::Status::Done) {
        std::cout << "Invalid server address. Please try again." << std::endl;
        return;
    }
    std::cout << "Connected to server " << server.Any << std::endl;
